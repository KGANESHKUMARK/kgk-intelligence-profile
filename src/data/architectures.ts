...
export const architectures: Architecture[] = [
  ...
  /* --------------------------------------------------- 2. Event-driven output */
  {
    ...
    nodes: [
      ...
      { id: 'cortex', label: 'Cortex AI + Claude + Bedrock', row: 3, col: 2, span: 2, tone: 'ai', kind: 'ai', summary: 'Intelligent document processing and AI-assisted insight.', points: ['LLM inference next to the data (Cortex AI)', 'Claude AI for document understanding', 'Amazon Bedrock (Titan) for additional model access', 'AI Guardrails and MCP for safe, standardised tool use'] },
