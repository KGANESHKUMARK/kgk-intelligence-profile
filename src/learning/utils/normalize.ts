...
export const ALIASES: Record<string, string> = {
  ...
  // React
  'virtual-dom': 'react-overview',
  vdom: 'react-overview',
  reconciliation: 'react-reconciliation',
  fiber: 'react-reconciliation',
  jsx: 'react-jsx',
  props: 'react-components-props',
  ...
  usememo: 'react-usememo-usecallback',
  usecallback: 'react-usememo-usecallback',
  'use-memo': 'react-usememo-usecallback',
  'use-callback': 'react-usememo-usecallback',
  usecontext: 'react-usecontext',
  'use-context': 'react-usecontext',
  context: 'react-usecontext',
  usereducer: 'react-usereducer-custom-hooks',
  'custom-hook': 'react-usereducer-custom-hooks',
  'custom-hooks': 'react-usereducer-custom-hooks',
  memo: 'react-react-memo',
  'react-memo': 'react-react-memo',
  memoization: 'react-usememo-usecallback',
  virtualization: 'react-virtualization',
  windowing: 'react-virtualization',
  debounce: 'react-debounce-throttle',
  throttling: 'react-debounce-throttle',
  abortcontroller: 'react-request-cancellation',
  'abort-controller': 'react-request-cancellation',
  'cursor-pagination': 'react-pagination-cursor',
  'infinite-scroll': 'react-pagination-cursor',
  'error-boundary': 'react-error-boundaries',
  'error-boundaries': 'react-error-boundaries',
  redux: 'react-redux-toolkit',
  'redux-toolkit': 'react-redux-toolkit',
  rtk: 'react-redux-toolkit',
  'tanstack-query': 'react-tanstack-query',
  'react-query': 'react-tanstack-query',
  usequery: 'react-tanstack-query',
  ssr: 'react-nextjs-rendering',
  ssg: 'react-nextjs-rendering',
  isr: 'react-nextjs-rendering',
  'server-components': 'react-nextjs-rendering',
  rbac: 'react-security-rbac',
};
